...
import styles from "../styles/EmblaCarouselArrowButtons.module.css";
...
export const PrevButton = (props: ComponentPropsWithRef<"button">) => {
    ...
    return (
        <div className={styles.button_container}>
            <button className={`${styles.embla__button} ${styles["embla__button--prev"]}`} type="button" {...restProps}>
...
export const NextButton = (props: ComponentPropsWithRef<"button">) => {
    ...
    return (
        <div className={styles.button_container}>
            <button className={`${styles.embla__button} ${styles["embla__button--next"]}`} type="button" {...restProps}>
                <svg className={styles.embla__button__svg} viewBox="0 0 532 532">
                    <path
                        fill="currentColor"
